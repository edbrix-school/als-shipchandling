...
@NoArgsConstructor
@AllArgsConstructor
public class ArSchSalesInvoiceHdrDto {
    ...
    // Detail tables
    private List<ArSchSalesInvoiceDtlDto> invoiceDetails;
    private List<ArSchSalesDnDtlDto> deliveryNoteDetails;
    private List<ArSchSalesInvCostbkdDtlDto> costBookedDetails;
}
