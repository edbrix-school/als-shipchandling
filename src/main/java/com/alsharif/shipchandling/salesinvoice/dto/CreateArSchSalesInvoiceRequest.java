...
@NoArgsConstructor
@AllArgsConstructor
public class CreateArSchSalesInvoiceRequest {
    ...
    // Detail tables
    private List<CreateArSchSalesInvoiceDtlRequest> invoiceDetails;
    private List<CreateArSchSalesDnDtlRequest> deliveryNoteDetails;
}
