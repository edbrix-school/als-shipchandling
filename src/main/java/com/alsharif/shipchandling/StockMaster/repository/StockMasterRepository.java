...
public interface StockMasterRepository
                extends JpaRepository<StockMasterEntity, Long>, JpaSpecificationExecutor<StockMasterEntity> {
        ...
        Optional<StockMasterEntity> findByBarcodeAndGroupPoidAndDeletedNot(String barcode, Long groupPoid,
                        String deleted);

        // Optional<StockMasterEntity>
        // findBySupplierBarcodeAndGroupPoidAndDeletedNot(String supplierBarcode, Long
        // groupPoid, String deleted);
