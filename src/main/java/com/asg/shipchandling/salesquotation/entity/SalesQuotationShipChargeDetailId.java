...
@Embeddable
public class SalesQuotationShipChargeDetailId implements Serializable {
    ...
    public SalesQuotationShipChargeDetailId() {
    }

    public SalesQuotationShipChargeDetailId(BigDecimal transactionPoid, BigDecimal detailRowId) {
    ...
    public boolean equals(Object o) {
        ...
        SalesQuotationShipChargeDetailId that = (SalesQuotationShipChargeDetailId) o;
