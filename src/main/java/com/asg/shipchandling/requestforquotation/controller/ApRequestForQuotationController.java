...
public class ApRequestForQuotationController {
    ...
    public ResponseEntity<?> deleteRequestForQuotation(
        ...
        rfqService.deleteRequestForQuotation(transactionPoid, UserContext.getGroupPoid(), UserContext.getCompanyPoid(), deleteReasonDto);
    ...
    @Operation(
            summary = "Generate PDF for Request For Quatation",
            description = "Generate PDF report for a specific Request For Quatation",
            responses = {
                    @ApiResponse(responseCode = "200", description = "PDF generated successfully",
                            content = @Content(mediaType = "application/pdf")),
                    @ApiResponse(responseCode = "404", description = "Request For Quatation not found"),
                    @ApiResponse(responseCode = "500", description = "Failed to generate PDF")
            }
    )
    @GetMapping("/printConfirmedSupplier/{transactionPoid}")
    public ResponseEntity<?> printConfirmedSupplier(
        ...
        try {
            ...
            log.error("Failed to generate PDF for Request For Quatation: {}", transactionPoid, e);
