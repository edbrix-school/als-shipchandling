...
public class ApRequestForQtnServiceImpl implements ApRequestForQtnService {
    ...
    @Override
    @Transactional(readOnly = true)
    public Page<com.asg.shipchandling.requestforquotation.dto.response.ApRequestForQtnListResponseDto> getAllRequestForQuotationsWithFilters(
        ...
        List<com.asg.shipchandling.requestforquotation.dto.response.ApRequestForQtnListResponseDto> dtos = results.stream()
    ...
    private com.asg.shipchandling.requestforquotation.dto.response.ApRequestForQtnListResponseDto mapToResponseDto(Object[] row) {
        com.asg.shipchandling.requestforquotation.dto.response.ApRequestForQtnListResponseDto dto = 
            new com.asg.shipchandling.requestforquotation.dto.response.ApRequestForQtnListResponseDto();
