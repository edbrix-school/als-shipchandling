...
public interface ApRequestForQtnService {
    ...
    org.springframework.data.domain.Page<com.asg.shipchandling.requestforquotation.dto.response.ApRequestForQtnListResponseDto> getAllRequestForQuotationsWithFilters(
