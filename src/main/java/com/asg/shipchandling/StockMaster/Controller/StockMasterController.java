...
public class StockMasterController {
    ...
    public ResponseEntity<?> validateStockCode(
        ...
        ValidationResponse response = stockMasterService.validateStockCode(stockCode, groupPoid, excludeStockPoid);
    ...
    public ResponseEntity<?> validateStockName(
        ...
        ValidationResponse response = stockMasterService.validateStockName(stockName, groupPoid, excludeStockPoid);
    ...
    public ResponseEntity<?> checkStockMasterDependencies(
        ...
        StockMasterDependenciesDto dto = stockMasterService.checkStockMasterDependencies(stockPoid, groupPoid);
    ...
    public ResponseEntity<?> deleteStockMaster(
        ...
        stockMasterService.deleteStockMaster(stockPoid, groupPoid);
    ...
    public ResponseEntity<?> createStockMaster(
        ...
        StockMasterDto dto = stockMasterService.createStockMaster(request, groupPoid, companyPoid, userId);
...
public ResponseEntity<StockMasterDto> updateStockMaster(
    ...
    StockMasterDto updated = stockMasterService.updateStockMaster(stockPoid, request, groupPoid, companyPoid, userId);
    ...
    public ResponseEntity<?> addSupplierDetail(
        ...
        StockMasterDtlDto dto = stockMasterService.addSupplierDetail(
                stockPoid, request, groupPoid, userId);
    ...
    public ResponseEntity<?> updateSupplierDetail(
        ...
        StockMasterDtlDto dto = stockMasterService.updateSupplierDetail(
                stockPoid, detRowId, request, groupPoid, userId);
    ...
    public ResponseEntity<?> deleteSupplierDetail(
        ...
        stockMasterService.deleteSupplierDetail(stockPoid, detRowId, groupPoid);
    ...
    public ResponseEntity<?> getSupplierDetails(
        ...
        List<StockMasterDtlDto> supplierDetails = stockMasterService.getSupplierDetails(stockPoid, groupPoid);
    ...
    public ResponseEntity<?> deleteWarehouseDetail(
        ...
        stockMasterService.deleteWarehouseDetail(stockPoid, detRowId, groupPoid);
    ...
    public ResponseEntity<?> getWarehouseDetails(
        ...
        List<StockMasterWarehouseDtlDto> warehouseDetails = stockMasterService.getWarehouseDetails(stockPoid, groupPoid);
