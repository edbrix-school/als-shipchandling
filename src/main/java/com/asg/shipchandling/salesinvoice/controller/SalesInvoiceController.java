...
import com.asg.shipchandling.salesinvoice.dto.FilterRequestDto;
...
import com.asg.shipchandling.salesinvoice.dto.PaginatedResponse;
...
public class SalesInvoiceController {
        ...
        public ResponseEntity<?> createSalesInvoice(
                ...
                log.info("Creating sales invoice with groupId: {} companyId: {} userId: {}", groupPoid, companyPoid,
                                userId);
        ...
        public ResponseEntity<?> updateItemDetail(
                ...
                log.info("Updating item detail in sales invoice with transactionPoid: {} detRowId: {} groupId: {} companyId: {}",
                                transactionPoid, detRowId, groupPoid, companyPoid);
        ...
        public ResponseEntity<?> getItemDetails(
                ...
                log.info("Fetched {} item details for sales invoice with transactionPoid: {} groupId: {} companyId: {}",
                                itemDetails != null ? itemDetails.size() : 0, transactionPoid, groupPoid, companyPoid);
        ...
        public ResponseEntity<?> getDeliveryNoteDetails(
                ...
                log.info("Fetched {} delivery note details for sales invoice with transactionPoid: {} groupId: {} companyId: {}",
                                dnDetails != null ? dnDetails.size() : 0, transactionPoid, groupPoid, companyPoid);
        ...
        public ResponseEntity<?> getCostBookedDetails(
                ...
                log.info("Fetched {} cost booked details for sales invoice with transactionPoid: {} groupId: {} companyId: {}",
                                costBookedDetails != null ? costBookedDetails.size() : 0, transactionPoid, groupPoid,
                                companyPoid);
        ...
        public ResponseEntity<?> calculateItemDiscountCommission(
                ...
                log.info("Calculating item discount/commission for sales invoice with transactionPoid: {} detRowId: {} groupId: {} companyId: {} userId: {}",
                                transactionPoid, detRowId, groupPoid, companyPoid, userId);
        ...
        public ResponseEntity<?> validateCustomer(
                        ...
                        @RequestParam(required = true) String documentId,
                        @RequestParam(required = true) String actionRequested) {
                log.info("Validating customer with customerPoid: {} groupId: {} companyId: {}", customerPoid, groupPoid,
                                companyPoid);
                ValidationResponse response = invoiceService.validateCustomer(
                                customerPoid, groupPoid, companyPoid);
                log.info("Customer validated with customerPoid: {} groupId: {} companyId: {}", customerPoid, groupPoid,
                                companyPoid);
